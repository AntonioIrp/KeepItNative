...
public class AppRate {
	...
	public void monitor() {
		...
		PreferenceHelper.setLaunchTimes(context,
				PreferenceHelper.getLaunchTimes(context) + 1);
	}
	...
	public void showRateDialog(Activity activity) {
		DialogManager.create(activity, isShowNeutralButton, listener, view)
				.show();
	}

	public boolean isOverEventPass() {
		return eventsTimes != -1
				&& PreferenceHelper.getEventTimes(context) > eventsTimes;
	}
	...
	private boolean isOverRemindDate() {
		return isOverDate(PreferenceHelper.getRemindInterval(context),
				remindInterval);
	}
